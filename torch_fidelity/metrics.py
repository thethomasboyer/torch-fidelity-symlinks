...
def calculate_metrics(**kwargs):
    ...
    Args:
        ...
        num_workers (int or None): Number of workers used by dataset DataLoader. If `None`, selected automatically
            and controlled by :paramref:`~calculate_metrics.save_cpu_ram`; if set, overrides this behavior in all
            cases. Must be non-negative when provided. Default: `None`.
